...
As you may notice, you can't use web related scope with this implementation. To do so, you need to create a CDI extension that will provide a RequestScoped related context and handle requests from `Global` object to feed that context. I will try to write a blog post about it later.
